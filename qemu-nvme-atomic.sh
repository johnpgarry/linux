/home/john/mnt_sda4/john/qemu-1/build/qemu-system-x86_64 -name guest=niklas-qemu-test,debug-threads=on \
			...
			\
			-device nvme,id=nvme-ctrl-0,serial=deadbee0,atomic.dn=on,atomic.awun=63,atomic.awupf=63 \
			-device nvme-ns,drive=mynvme0,bus=nvme-ctrl-0 \
			-drive file=~/mnt_sda4/john/nvme-rootfs-small.img,if=none,id=mynvme0 
