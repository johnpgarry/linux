...
static int nvme_mpath_pr_preempt(struct mpath_device *mpath_device, u64 old, u64 new,
		...
		unsigned int flags)
{
	...
	return nvme_mpath_pr_register(mpath_device, old_key, new_key, flags);
}
		...
		enum pr_type type, unsigned flags)
{
	...
	return nvme_mpath_pr_reserve(mpath_device, key, type, flags);
}
		...
		enum pr_type type, bool abort)
{
	...
	return nvme_mpath_pr_preempt(mpath_device, old, new, type, abort);
}
...
static int nvme_pr_clear(struct block_device *bdev, u64 key)
{
	...
	return nvme_mpath_pr_clear(mpath_device, key);
}
...
static int nvme_pr_release(struct block_device *bdev, u64 key, enum pr_type type)
{
	...
	return nvme_mpath_pr_release(mpath_device, key, type);
}
		...
		struct pr_keys *keys_info)
{
	...
	return nvme_mpath_pr_read_keys(mpath_device, keys_info);
}
		...
		struct pr_held_reservation *resv)
{
	...
	return nvme_mpath_pr_read_reservation(mpath_device, resv);
}
