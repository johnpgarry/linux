...
static void alua_rtpg_queue_simple(struct scsi_device *sdev)
{
					      ...
					      struct scsi_sense_hdr *sense_hdr)
{
	return scsi_alua_check_sense(sdev, sense_hdr,
		alua_handle_state_transition, alua_rtpg_queue_simple);
}
...
static blk_status_t alua_prep_fn(struct scsi_device *sdev, struct request *req)
{
	...
	return scsi_alua_prep_cmd(blk_mq_rq_to_pdu(req), state);
}
