	...
	struct xfs_dinode	*from)
{
	...
	pr_err("%s ip=%pS i_ino=%lld i_mount=%pS xfs_inode_has_forcealign=%d i_extsize=%d rt=%d\n",
	...
	pr_err("%s2 ip=%pS i_ino=%lld i_awu_max=%d xfs_inode_has_forcealign=%d i_extsize=%d rt=%d\n",
