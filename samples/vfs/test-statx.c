...
static void dump_statx(struct statx *stx)
{
	...
	if (stx->stx_attributes_mask) {
		...
		if (stx->stx_attributes & STATX_ATTR_WRITE_ATOMIC) {
			printf("%s STATX_ATTR_WRITE_ATOMIC set:\n", __func__);
			printf("%s stx_atomic_write_unit_min=%d\n", __func__, stx->stx_atomic_write_unit_min);
			printf("%s stx_atomic_write_unit_max=%d\n", __func__, stx->stx_atomic_write_unit_max);
			printf("%s stx_atomic_write_segments_max=%d\n", __func__, stx->stx_atomic_write_segments_max);
			printf("%s stx_atomic_write_unit_max_opt=%d\n", __func__, stx->stx_atomic_write_unit_max_opt);
		}
