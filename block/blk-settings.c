...
void blk_queue_write_atomic_offset(struct request_queue *q, unsigned int offset)
{
	q->limits.queue_write_atomic_offset = offset;
}
EXPORT_SYMBOL_GPL(blk_queue_write_atomic_offset);
