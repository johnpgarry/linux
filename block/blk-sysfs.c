...
static ssize_t queue_write_atomic_offset_show(struct request_queue *q, char *page)
{
	return queue_var_show(q->limits.queue_write_atomic_offset, page);
}
...
QUEUE_RO_ENTRY(queue_write_atomic_offset, "write_atomic_offset");
...
static struct attribute *queue_attrs[] = {
	...
	&queue_write_atomic_offset_entry.attr,
	NULL,
};
